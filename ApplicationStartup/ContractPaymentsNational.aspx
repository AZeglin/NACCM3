<%@ Page Title="" Language="C#" MasterPageFile="~/ContractView.Master" StylesheetTheme="CMStandard" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="ContractPaymentsNational.aspx.cs" Inherits="VA.NAC.CM.ApplicationStartup.ContractPaymentsNational" %>
   ...
   <table class="OuterTable" >
        <tr>
          <td style="vertical-align:top;" >
                <asp:FormView ID="PaymentsNationalHeaderFormView" runat="server" Width="100%" Height="100%" DefaultMode="Edit" OnPreRender="PaymentsNationalHeaderFormView_OnPreRender" >
                    <EditItemTemplate>
                    <table class="OutsetBox" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;" >
                                    <asp:Button runat="server" ID="AddPaymentButton" Text="Add Payment" OnClick="AddNewPaymentButton_OnClick"  />
                                </td>
        ...
        <tr>
            <td style="vertical-align:top;" >
                ...
                <asp:Panel ID="PaymentNationalGridPanel" runat="server" Width="100%" Height="100%"  OnPreRender="PaymentNationalGridPanel_OnPreRender" >
                    ...
                    <div id="PaymentGridViewDiv"  runat="server"  style="border:3px solid black; height:398px; overflow: scroll" onscroll="javascript:setPaymentScrollForRestore( this );"  onkeypress="javascript:setPaymentScrollForRestore( this );"  >
                        ...
                        <ep:GridView ID="PaymentGridView" 
                                    ...
                                    OnRowDeleting="PaymentGridView_RowDeleting" 
                                    OnRowEditing="PaymentGridView_RowEditing" 
                                    OnRowUpdating="PaymentGridView_RowUpdating" 
                                    OnRowCancelingEdit="PaymentGridView_RowCancelingEdit"
                                    AllowInserting="True"
                                    OnRowInserting="PaymentGridView_RowInserting" 
                                    ...
                                    Font-Names="Arial" 
                                    Font-Size="small" >
                                <HeaderStyle CssClass="PaymentGridHeaders" />
                                ...
                                <Columns>   
                                        ...
                                        <asp:TemplateField >  
                                        <ItemTemplate>
                                                <asp:Button  CausesValidation="false" Visible="true" runat="server" ID="EditButton" Text="Edit" OnCommand="PaymentGridView_ButtonCommand"   CommandName="EditPayment"  CommandArgument='<%#  Container.DataItemIndex  + "," +  Eval("SRPActivityId")  %>' ButtonType="Button"  Width="62px"   >
                                                </asp:Button>   

                                                <asp:Button  CausesValidation="false" Visible="false" runat="server" ID="SaveButton" Text="Save" OnCommand="PaymentGridView_ButtonCommand"   CommandName="SavePayment" OnClick="Save_ButtonClick"  CommandArgument='<%#  Container.DataItemIndex  + "," +  Eval("SRPActivityId") %>' ButtonType="Button"  Width="62px"   >
                                                </asp:Button>   

                                                <asp:Button CausesValidation="false"  Visible="false" runat="server" ID="CancelButton" Text="Cancel" OnCommand="PaymentGridView_ButtonCommand"   CommandName="Cancel"  CommandArgument='<%#  Container.DataItemIndex  + "," +  Eval("SRPActivityId") %>' ButtonType="Button"  Width="62px"   >
                                                </asp:Button>   
                                  
                                        </ItemTemplate>
                                    </asp:TemplateField>      
                                            
                                    <asp:TemplateField HeaderText="Year Quarter"  ItemStyle-Width="7%" >
                                    <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Payment Amount" ItemStyle-Width="6%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <ep:TextBox ID="paymentAmountTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "PaymentAmount", "{0:0.00}" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                            
                                      <asp:TemplateField HeaderText="Submission<br />Date" ItemStyle-Width="5%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <ep:TextBox ID="submissionDateTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "SubmissionDate", "{0:d}" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                            
                                     <asp:TemplateField HeaderText="Submitted By" ItemStyle-Width="10%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                         ...
                                         <EditItemTemplate>
                                            <ep:TextBox ID="submittedByTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "SubmittedByUserName" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                            
                                     <asp:TemplateField HeaderText="Payment <br />Method" ItemStyle-Width="4%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                         ...
                                         <EditItemTemplate>
                                              <asp:DropDownList ID="paymentMethodDropDownList"  Width="120px"    runat="server" OnDataBound="paymentMethodDropDownList_DataBound" OnSelectedIndexChanged="paymentMethodDropDownList_OnSelectedIndexChanged"  AutoPostBack="true"  CssClass="rightAlign" >
                                        </asp:DropDownList>
                                        </EditItemTemplate>
                                    </asp:TemplateField>   
                                     ...
                                     <asp:TemplateField HeaderText="Payment <br />Source" ItemStyle-Width="3%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                         ...
                                         <EditItemTemplate>
                                            <ep:TextBox ID="paymentSourceTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "PaymentSource" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>   
                                     ...
                                     <asp:TemplateField HeaderText="Transaction Id" ItemStyle-Width="7%" ItemStyle-Height="99%" >
                                        <ItemTemplate>
                                         ...
                                         <EditItemTemplate>
                                            <ep:TextBox ID="transactionIdTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "TransactionId" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>   

                                        <asp:TemplateField HeaderText="Tracking Id" ItemStyle-Width="7%" >
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <ep:TextBox ID="trackingIdTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "PayGovTrackingId" )%>'  CssClass="rightAlign" > </ep:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
 

                                       <asp:TemplateField  HeaderText="Deposit Number"  ItemStyle-Width="7%" >
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <ep:TextBox ID="depositNumberTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "DepositTicketNumber" )%>'  CssClass="rightAlign" ></ep:TextBox>                                     
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField  HeaderText="Debit Voucher<br />Number"  ItemStyle-Width="7%" >
                                       ...
                                       <EditItemTemplate>
                                            <ep:TextBox ID="debitVoucherNumberTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "DebitVoucherNumber" )%>'  CssClass="rightAlign" ></ep:TextBox>                                     
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Settlement<br />Date"  ItemStyle-Width="5%" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Payment Comments"  ItemStyle-Width="40%" ItemStyle-Wrap="true" >
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                             <ep:TextBox ID="paymentCommentsTextBox" runat="server" TextMode="MultiLine"  MaxLength="255"  Width="99%" Text='<%# DataBinder.Eval( Container.DataItem, "Comments" )%>'  ></ep:TextBox>                                     
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField >
                                        <ItemTemplate>                                                                                         
                                                <asp:Button runat="server"  ID="RemovePaymentButton" Text="Remove Payment" OnDataBinding="RemovePaymentButton_DataBinding"  OnCommand="PaymentGridView_ButtonCommand" CommandName="RemovePayment" CommandArgument='<%# Container.DataItemIndex + "," +  Eval("SRPActivityId") %>' ButtonType="Button" Width="104px" >            
                                                </asp:Button >                                    
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Button runat="server"  ID="RemovePaymentButton" Text="Remove Payment" OnDataBinding="RemovePaymentButton_DataBinding"  OnCommand="PaymentGridView_ButtonCommand" CommandName="RemovePayment" CommandArgument='<%# Container.DataItemIndex + "," +  Eval("SRPActivityId") %>' ButtonType="Button" Width="104px" >            
