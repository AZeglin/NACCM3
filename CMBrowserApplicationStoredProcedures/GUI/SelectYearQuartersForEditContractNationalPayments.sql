IF EXISTS ( SELECT * FROM sysobjects WHERE type = 'P' AND name = 'SelectYearQuartersForEditContractNationalPayments' )
BEGIN
	DROP PROCEDURE SelectYearQuartersForEditContractNationalPayments
END
GO

CREATE PROCEDURE SelectYearQuartersForEditContractNationalPayments
(
