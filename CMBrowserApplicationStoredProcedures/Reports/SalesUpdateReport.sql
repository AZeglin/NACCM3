...
BEGIN TRANSACTION
	...
	e.OldValue,
	e.NewValue,
	case when d.PaymentAmount is NULL then ''NO'' else ''YES'' end as paymentposted ,
	case when d.CreationDate is NULL then ''N/A'' else convert (nvarchar(20), d.CreationDate, 101) end as Paymentposteddate,
	...
	left outer join NAC_CM.dbo.CM_PaymentsReceived d
	on c.CntrctNum = d.ContractNumber and c.Quarter_ID = d.QuarterId'
