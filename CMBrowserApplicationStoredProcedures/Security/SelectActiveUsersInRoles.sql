IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'SelectActiveUsersInRoles')
	BEGIN
		DROP  Procedure  SelectActiveUsersInRoles
	END

GO

CREATE Procedure SelectActiveUsersInRoles
(
