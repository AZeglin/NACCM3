IF EXISTS ( SELECT * FROM sysobjects WHERE type = 'P' AND name = 'SelectOfferHeaders2' )
BEGIN
	DROP PROCEDURE SelectOfferHeaders2
END
GO

CREATE PROCEDURE SelectOfferHeaders2
(
