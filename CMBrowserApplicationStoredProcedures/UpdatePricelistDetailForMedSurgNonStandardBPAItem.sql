IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'UpdatePricelistDetailForMedSurgNonStandardBPAItem')
	BEGIN
		DROP  Procedure  UpdatePricelistDetailForMedSurgNonStandardBPAItem
	END

GO

CREATE Procedure UpdatePricelistDetailForMedSurgNonStandardBPAItem
(
...
BEGIN TRANSACTION
	...
	select @PriceExists = dbo.CheckForDuplicateMedSurgBPAPriceFunction( @ExistingContractNumber, null, @BPADescription, @BPAPrice, @BPAEffectiveDate, @BPAExpirationDate, @BPALogNumber, 0 )
