IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[CheckIfNDCChangedProc1]') AND type in (N'P', N'PC'))
DROP PROCEDURE [CheckIfNDCChangedProc1]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE proc [dbo].[CheckIfNDCChangedProc1]
(
@ndc_1 char(5),
@ndc_2 char(4),
@ndc_3 char(2),
