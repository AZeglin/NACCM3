...
GO
CREATE procedure [dbo].[ProcessFSSItemsData]
As
...
Declare @cnt_no nvarchar(20),
	...
	Declare FSSPrice_Cursor CURSOR For
		...
		From FSSPrice where (len(N) = 0 or N is null)
	...
	BEGIN
		Select @drugitemid = Null,@contractid = Null, @drugItemNDCId = Null,@subitemid = null,@drugitempriceid = null
		...
		Begin
			...
			BEGIN
				...
				Insert into DI_ItemFSSPriceStatus
