IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'ProcessPriceStopDateForFSS')
	BEGIN
		DROP  Procedure  ProcessPriceStopDateForFSS
	END

GO

CREATE Procedure ProcessPriceStopDateForFSS
As
	...
	BEGIN
		...
		Begin
			...
			Begin
				...
				Select
					@drugitempriceid,@drugitemid,@contractExpDate,@discontinuationDate,@pricestopdate,
					@discontinuationDate,'Expired','FSS'			
			End
		End
		Else
		Begin
