...
Begin Transaction
	...
	Begin
		...
		SET @dtsCommand = 'DTSRun /S "AMMHINTESTAPP\nactrn"  /N "NACCMPriceListExport" /V "{5271F617-DA75-4A7A-BC3E-1504606EA64F}" /A "glvdatevalue":"8"="' + @currentdate + '" /A "glvcontractnumber":"8"="' + @contractNumber +  '" /A "glvdestinationpath":"8"="' + @DestinationPath + '" /W "0" /E'  
	...
	Begin
		...
		Begin
			SET @dtsCommand = 'DTSRun /S "AMMHINTESTAPP\nactrn" /N "DrugItemPriceListExport" /V "{2DE45AAD-5C11-4574-BA0A-315595CF9521}" /A "glvfilename":"8"="' + @filepath + '" /A "glvcontractnumber":"8"="' + @contractNumber +  '" /A "glvcovered":"8"="' + @covered +  '" /W "0" /E'  		
		End
		...
		Else
		Begin
			SET @dtsCommand = 'DTSRun /S "AMMHINTESTAPP\nactrn" /N "DrugItemPriceListExport" /V "{3DE193A6-D312-4836-A337-1EF895333E76}" /A "glvfilename":"8"="' + @filepath + '" /A "glvcontractnumber":"8"="' + @contractNumber +  '" /A "glvstartdate":"7"="' + @StartDate +  '" /A "glvstopdate":"7"="' + @EndDate +   '" /A "glvcovered":"8"="' + @covered +  '" /W "0" /E'  
		End
	End
