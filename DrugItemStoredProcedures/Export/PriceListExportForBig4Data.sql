IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'PriceListExportForBig4Data')
	BEGIN
		DROP  Procedure  PriceListExportForBig4Data
	END

GO

CREATE Procedure PriceListExportForBig4Data
