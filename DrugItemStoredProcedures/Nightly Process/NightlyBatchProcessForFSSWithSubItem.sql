IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'NightlyBatchProcessForFSSWithSubItem')
	BEGIN
		DROP  Procedure  NightlyBatchProcessForFSSWithSubItem
	END

GO

CREATE Proc [dbo].[NightlyBatchProcessForFSSWithSubItem]
As
...
BEGIN
	...
	Select DrugItemPriceId,@drugItemId,@subitemid,PriceId,PriceStartDate,PriceStopDate,Price,0,1,0,
