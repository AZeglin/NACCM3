IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'NightlyBatchProcessForRestrictedWithoutSubItem')
	BEGIN
		DROP  Procedure  NightlyBatchProcessForRestrictedWithoutSubItem
	END

GO

CREATE Proc [dbo].[NightlyBatchProcessForRestrictedWithoutSubItem]
As
...
BEGIN
	...
	Select  DrugItemPriceId,@drugItemId,null,PriceId,PriceStartDate,PriceStopDate,Price,0,0,0,
