IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestScenario1-2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [TestScenario1-2]
GO
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[TestScenario1-2]
(
@IsFSS bit,
@IsBig4 bit,
@IsRestricted bit,
...
DECLARE
	...
	select @date2 = '2010-11-10'
	select @date5 = '2010-11-20'
	
	/* dates for new price scenarios */
	select @date0 = '2010-11-2'
	select @date1 = '2010-11-4'
	select @date3 = '2010-11-12'
	select @date4 = '2010-11-14'
	select @date6 = '2010-11-22'
	select @date7 = '2010-11-24'
