...
namespace VA.NAC.NACCMBrowser.BrowserObj
{
    ...
    [Serializable]
    public class EditContractSalesWindowParms2
    {
        // editing existing quarter
        public EditContractSalesWindowParms2( int itemIndex, string contractNumber, int quarterId, int year, int quarter )
        {
        ...
        // adding new quarter
        public EditContractSalesWindowParms2( string contractNumber )
        {
            _bIsNewQuarter = true;
            _contractNumber = contractNumber;
        }
